document.addEventListener("DOMContentLoaded", function () {
  ...
  if (token) {
    ...
    // profileButton.classList.remove("d-none"); // If profileButton is used, remove d-none here
  } else {
    // Token does not exist, show login and register buttons and hide profile and logout buttons
    loginButton.classList.remove("d-none");
    registerButton.classList.remove("d-none");
    logoutButton.classList.add("d-none"); // Ensure logoutButton is hidden when no token
